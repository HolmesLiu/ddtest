...
let shareCodes = [ // IOS本地脚本用户这个列表填入你要助力的好友的shareCode
  ...
  'MTAxODc2NTEzMjAwMDAwMDAxNTg1Nzk1NQ==@MTAxODc2NTEzOTAwMDAwMDAxNTk4OTg3Mw==@MTE0MDkyMjIwMDAwMDAwNDgzNzU1MDM=@MTEyNjkzMjAwMDAwMDAwMDUwMzUyNDk5',
...
function readShareCode() {
  return new Promise(async resolve => {
    $.get({url: "https://www.lvxiu.net/js/JD_Pet.json",headers:{
